...
get_ipython().system('pip list|grep nltk')
...
def TripletLossFn(v1, v2, margin=0.25):
    ...
    mask_exclude_positives = (fastnp.eye(batch_size) == 1)|(negative_zero_on_duplicate>positive.reshape(batch_size,1))
